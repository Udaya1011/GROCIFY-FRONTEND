          ...
          <div className="flex gap-3">
            <div className="flex flex-col gap-3">
              {product.image.map((image, index) => (
                ...
                >
                  <img
                    src={image.startsWith('http') || image.startsWith('data:') || image.startsWith('/') ? image : `${import.meta.env.VITE_BACKEND_URL || (window.location.hostname.includes('onrender.com') ? 'https://grocify-backend-1.onrender.com' : 'http://localhost:5000')}/images/${image}`}
            ...
            <div className="border border-gray-500/30 max-w-100 rounded overflow-hidden">
              <img
                src={thumbnail && (thumbnail.startsWith('http') || thumbnail.startsWith('data:') || thumbnail.startsWith('/') ? thumbnail : `${import.meta.env.VITE_BACKEND_URL || (window.location.hostname.includes('onrender.com') ? 'https://grocify-backend-1.onrender.com' : 'http://localhost:5000')}/images/${thumbnail}`)}
