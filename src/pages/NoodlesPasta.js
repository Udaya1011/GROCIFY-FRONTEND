...
import { assets, noodlesPastaProducts } from "../assets/assets";
...
const NoodlesPasta = () => {
    ...
    const [filteredProducts, setFilteredProducts] = useState(noodlesPastaProducts);

    const categories = ["All", "Noodles", "Pasta"];

    useEffect(() => {
        if (filter === "All") {
            setFilteredProducts(noodlesPastaProducts);
        } else {
            setFilteredProducts(
                noodlesPastaProducts.filter((product) => product.subCategory === filter)
            );
        }
    }, [filter]);
    ...
    return (
        <div className="mt-20 pb-20">
            ...
            <div className="flex items-center gap-2 text-gray-500 text-sm mb-6">
                ...
                <span>&gt;</span>
                <span className="text-indigo-600 font-medium">Noodles & Pasta</span>
            </div>
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
                <div>
                    ...
                    <p className="text-gray-500 mt-2">
                        Explore our wide range of delicious noodles and pasta types.
                    </p>
                </div>
                <button
