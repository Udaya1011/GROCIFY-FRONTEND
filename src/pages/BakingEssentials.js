...
import { assets, bakingEssentialsProducts } from "../assets/assets";
...
const BakingEssentials = () => {
    ...
    const [filteredProducts, setFilteredProducts] = useState(bakingEssentialsProducts);
    ...
    useEffect(() => {
        let result = bakingEssentialsProducts;
    ...
    return (
        <div className="mt-20 pb-20">
            ...
            <div className="flex items-center gap-2 text-gray-500 text-sm mb-6">
                ...
                <span>&gt;</span>
                <span className="text-indigo-600 font-medium">Baking Essentials</span>
            </div>
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
                <div>
                    ...
                    <p className="text-gray-500 mt-2">
                        Everything you need to bake delicious treats at home. Quality ingredients and tools.
                    </p>
                </div>
