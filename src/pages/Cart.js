            ...
            <div className="flex items-center md:gap-6 gap-3">
              ...
              >
                <img
                  ...
                  src={product.image[0].startsWith('http') || product.image[0].startsWith('data:') || product.image[0].startsWith('/') ? product.image[0] : `http://localhost:5000/images/${product.image[0]}`}
                  alt={product.name}
                />
              </div >
              <div>
